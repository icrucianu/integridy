 ...
 */
@Entity
@Table(name = "cumul_dso_m")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "CumulDsoM.findAll", query = "SELECT c FROM CumulDsoM c")
    , @NamedQuery(name = "CumulDsoM.findById", query = "SELECT c FROM CumulDsoM c WHERE c.id = :id")
    , @NamedQuery(name = "CumulDsoM.findByActivePow", query = "SELECT c FROM CumulDsoM c WHERE c.activePow = :activePow")
    , @NamedQuery(name = "CumulDsoM.findByCo2", query = "SELECT c FROM CumulDsoM c WHERE c.co2 = :co2")
    , @NamedQuery(name = "CumulDsoM.findByConsumedActivePow", query = "SELECT c FROM CumulDsoM c WHERE c.consumedActivePow = :consumedActivePow")
    , @NamedQuery(name = "CumulDsoM.findByConsumedReactivePow", query = "SELECT c FROM CumulDsoM c WHERE c.consumedReactivePow = :consumedReactivePow")
    , @NamedQuery(name = "CumulDsoM.findByCreatedTime", query = "SELECT c FROM CumulDsoM c WHERE c.createdTime = :createdTime")
    , @NamedQuery(name = "CumulDsoM.findByDayCost", query = "SELECT c FROM CumulDsoM c WHERE c.dayCost = :dayCost")
    , @NamedQuery(name = "CumulDsoM.findByDeviceNumber", query = "SELECT c FROM CumulDsoM c WHERE c.deviceNumber = :deviceNumber")
    , @NamedQuery(name = "CumulDsoM.findByDownTime", query = "SELECT c FROM CumulDsoM c WHERE c.downTime = :downTime")
    , @NamedQuery(name = "CumulDsoM.findByEnergyMismatch", query = "SELECT c FROM CumulDsoM c WHERE c.energyMismatch = :energyMismatch")
    , @NamedQuery(name = "CumulDsoM.findByEnergyMismatchRatio", query = "SELECT c FROM CumulDsoM c WHERE c.energyMismatchRatio = :energyMismatchRatio")
    , @NamedQuery(name = "CumulDsoM.findByNightCost", query = "SELECT c FROM CumulDsoM c WHERE c.nightCost = :nightCost")
    , @NamedQuery(name = "CumulDsoM.findBySaidi", query = "SELECT c FROM CumulDsoM c WHERE c.saidi = :saidi")
    , @NamedQuery(name = "CumulDsoM.findByPhaseVoltage", query = "SELECT c FROM CumulDsoM c WHERE c.phaseVoltage = :phaseVoltage")
    , @NamedQuery(name = "CumulDsoM.findByReactivePow", query = "SELECT c FROM CumulDsoM c WHERE c.reactivePow = :reactivePow")
    , @NamedQuery(name = "CumulDsoM.findBySendInterval", query = "SELECT c FROM CumulDsoM c WHERE c.sendInterval = :sendInterval")
    , @NamedQuery(name = "CumulDsoM.findByThdd", query = "SELECT c FROM CumulDsoM c WHERE c.thdd = :thdd")
    , @NamedQuery(name = "CumulDsoM.findByUpTime", query = "SELECT c FROM CumulDsoM c WHERE c.upTime = :upTime")
    , @NamedQuery(name = "CumulDsoM.findByVoltageDeviation", query = "SELECT c FROM CumulDsoM c WHERE c.voltageDeviation = :voltageDeviation")
    , @NamedQuery(name = "CumulDsoM.findByIdx12hours", query = "SELECT c FROM CumulDsoM c WHERE c.idx12hours = :idx12hours")
    , @NamedQuery(name = "CumulDsoM.findByIdx15minutes", query = "SELECT c FROM CumulDsoM c WHERE c.idx15minutes = :idx15minutes")
    , @NamedQuery(name = "CumulDsoM.findByIdx1day", query = "SELECT c FROM CumulDsoM c WHERE c.idx1day = :idx1day")
    , @NamedQuery(name = "CumulDsoM.findByIdx1hour", query = "SELECT c FROM CumulDsoM c WHERE c.idx1hour = :idx1hour")
    , @NamedQuery(name = "CumulDsoM.findByIdx1month", query = "SELECT c FROM CumulDsoM c WHERE c.idx1month = :idx1month")
    , @NamedQuery(name = "CumulDsoM.findByIdx1week", query = "SELECT c FROM CumulDsoM c WHERE c.idx1week = :idx1week")
    , @NamedQuery(name = "CumulDsoM.findByIdx1year", query = "SELECT c FROM CumulDsoM c WHERE c.idx1year = :idx1year")
    , @NamedQuery(name = "CumulDsoM.findByIdx3month", query = "SELECT c FROM CumulDsoM c WHERE c.idx3month = :idx3month")
    , @NamedQuery(name = "CumulDsoM.findByIdx6hours", query = "SELECT c FROM CumulDsoM c WHERE c.idx6hours = :idx6hours")
    , @NamedQuery(name = "CumulDsoM.findByIdx6month", query = "SELECT c FROM CumulDsoM c WHERE c.idx6month = :idx6month")})
public class CumulDsoM implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        CumulDsoM other = (CumulDsoM) object;
    ...
    public String toString() {
        return "ro.siveco.cad.integridy.entities.CumulDsoM[ id=" + id + " ]";
    }
