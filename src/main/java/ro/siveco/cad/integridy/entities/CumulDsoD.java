 ...
 */
@Entity
@Table(name = "cumul_dso_d")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "CumulDsoD.findAll", query = "SELECT c FROM CumulDsoD c")
    , @NamedQuery(name = "CumulDsoD.findById", query = "SELECT c FROM CumulDsoD c WHERE c.id = :id")
    , @NamedQuery(name = "CumulDsoD.findByActivePow", query = "SELECT c FROM CumulDsoD c WHERE c.activePow = :activePow")
    , @NamedQuery(name = "CumulDsoD.findByCo2", query = "SELECT c FROM CumulDsoD c WHERE c.co2 = :co2")
    , @NamedQuery(name = "CumulDsoD.findByConsumedActivePow", query = "SELECT c FROM CumulDsoD c WHERE c.consumedActivePow = :consumedActivePow")
    , @NamedQuery(name = "CumulDsoD.findByConsumedReactivePow", query = "SELECT c FROM CumulDsoD c WHERE c.consumedReactivePow = :consumedReactivePow")
    , @NamedQuery(name = "CumulDsoD.findByCreatedTime", query = "SELECT c FROM CumulDsoD c WHERE c.createdTime = :createdTime")
    , @NamedQuery(name = "CumulDsoD.findByDayCost", query = "SELECT c FROM CumulDsoD c WHERE c.dayCost = :dayCost")
    , @NamedQuery(name = "CumulDsoD.findByDeviceNumber", query = "SELECT c FROM CumulDsoD c WHERE c.deviceNumber = :deviceNumber")
    , @NamedQuery(name = "CumulDsoD.findByDownTime", query = "SELECT c FROM CumulDsoD c WHERE c.downTime = :downTime")
    , @NamedQuery(name = "CumulDsoD.findByEnergyMismatch", query = "SELECT c FROM CumulDsoD c WHERE c.energyMismatch = :energyMismatch")
    , @NamedQuery(name = "CumulDsoD.findByEnergyMismatchRatio", query = "SELECT c FROM CumulDsoD c WHERE c.energyMismatchRatio = :energyMismatchRatio")
    , @NamedQuery(name = "CumulDsoD.findByNightCost", query = "SELECT c FROM CumulDsoD c WHERE c.nightCost = :nightCost")
    , @NamedQuery(name = "CumulDsoD.findBySaidi", query = "SELECT c FROM CumulDsoD c WHERE c.saidi = :saidi")
    , @NamedQuery(name = "CumulDsoD.findByPhaseVoltage", query = "SELECT c FROM CumulDsoD c WHERE c.phaseVoltage = :phaseVoltage")
    , @NamedQuery(name = "CumulDsoD.findByReactivePow", query = "SELECT c FROM CumulDsoD c WHERE c.reactivePow = :reactivePow")
    , @NamedQuery(name = "CumulDsoD.findBySendInterval", query = "SELECT c FROM CumulDsoD c WHERE c.sendInterval = :sendInterval")
    , @NamedQuery(name = "CumulDsoD.findByThdd", query = "SELECT c FROM CumulDsoD c WHERE c.thdd = :thdd")
    , @NamedQuery(name = "CumulDsoD.findByUpTime", query = "SELECT c FROM CumulDsoD c WHERE c.upTime = :upTime")
    , @NamedQuery(name = "CumulDsoD.findByVoltageDeviation", query = "SELECT c FROM CumulDsoD c WHERE c.voltageDeviation = :voltageDeviation")
    , @NamedQuery(name = "CumulDsoD.findByIdx12hours", query = "SELECT c FROM CumulDsoD c WHERE c.idx12hours = :idx12hours")
    , @NamedQuery(name = "CumulDsoD.findByIdx15minutes", query = "SELECT c FROM CumulDsoD c WHERE c.idx15minutes = :idx15minutes")
    , @NamedQuery(name = "CumulDsoD.findByIdx1day", query = "SELECT c FROM CumulDsoD c WHERE c.idx1day = :idx1day")
    , @NamedQuery(name = "CumulDsoD.findByIdx1hour", query = "SELECT c FROM CumulDsoD c WHERE c.idx1hour = :idx1hour")
    , @NamedQuery(name = "CumulDsoD.findByIdx1month", query = "SELECT c FROM CumulDsoD c WHERE c.idx1month = :idx1month")
    , @NamedQuery(name = "CumulDsoD.findByIdx1week", query = "SELECT c FROM CumulDsoD c WHERE c.idx1week = :idx1week")
    , @NamedQuery(name = "CumulDsoD.findByIdx1year", query = "SELECT c FROM CumulDsoD c WHERE c.idx1year = :idx1year")
    , @NamedQuery(name = "CumulDsoD.findByIdx3month", query = "SELECT c FROM CumulDsoD c WHERE c.idx3month = :idx3month")
    , @NamedQuery(name = "CumulDsoD.findByIdx6hours", query = "SELECT c FROM CumulDsoD c WHERE c.idx6hours = :idx6hours")
    , @NamedQuery(name = "CumulDsoD.findByIdx6month", query = "SELECT c FROM CumulDsoD c WHERE c.idx6month = :idx6month")})
public class CumulDsoD implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        CumulDsoD other = (CumulDsoD) object;
    ...
    public String toString() {
        return "ro.siveco.cad.integridy.entities.CumulDsoD[ id=" + id + " ]";
    }
