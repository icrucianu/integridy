 ...
 */
@Entity
@Table(name = "cumul_dso_y")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "CumulDsoY.findAll", query = "SELECT c FROM CumulDsoY c")
    , @NamedQuery(name = "CumulDsoY.findById", query = "SELECT c FROM CumulDsoY c WHERE c.id = :id")
    , @NamedQuery(name = "CumulDsoY.findByActivePow", query = "SELECT c FROM CumulDsoY c WHERE c.activePow = :activePow")
    , @NamedQuery(name = "CumulDsoY.findByCo2", query = "SELECT c FROM CumulDsoY c WHERE c.co2 = :co2")
    , @NamedQuery(name = "CumulDsoY.findByConsumedActivePow", query = "SELECT c FROM CumulDsoY c WHERE c.consumedActivePow = :consumedActivePow")
    , @NamedQuery(name = "CumulDsoY.findByConsumedReactivePow", query = "SELECT c FROM CumulDsoY c WHERE c.consumedReactivePow = :consumedReactivePow")
    , @NamedQuery(name = "CumulDsoY.findByCreatedTime", query = "SELECT c FROM CumulDsoY c WHERE c.createdTime = :createdTime")
    , @NamedQuery(name = "CumulDsoY.findByDayCost", query = "SELECT c FROM CumulDsoY c WHERE c.dayCost = :dayCost")
    , @NamedQuery(name = "CumulDsoY.findByDeviceNumber", query = "SELECT c FROM CumulDsoY c WHERE c.deviceNumber = :deviceNumber")
    , @NamedQuery(name = "CumulDsoY.findByDownTime", query = "SELECT c FROM CumulDsoY c WHERE c.downTime = :downTime")
    , @NamedQuery(name = "CumulDsoY.findByEnergyMismatch", query = "SELECT c FROM CumulDsoY c WHERE c.energyMismatch = :energyMismatch")
    , @NamedQuery(name = "CumulDsoY.findByEnergyMismatchRatio", query = "SELECT c FROM CumulDsoY c WHERE c.energyMismatchRatio = :energyMismatchRatio")
    , @NamedQuery(name = "CumulDsoY.findByNightCost", query = "SELECT c FROM CumulDsoY c WHERE c.nightCost = :nightCost")
    , @NamedQuery(name = "CumulDsoY.findBySaidi", query = "SELECT c FROM CumulDsoY c WHERE c.saidi = :saidi")
    , @NamedQuery(name = "CumulDsoY.findByPhaseVoltage", query = "SELECT c FROM CumulDsoY c WHERE c.phaseVoltage = :phaseVoltage")
    , @NamedQuery(name = "CumulDsoY.findByReactivePow", query = "SELECT c FROM CumulDsoY c WHERE c.reactivePow = :reactivePow")
    , @NamedQuery(name = "CumulDsoY.findBySendInterval", query = "SELECT c FROM CumulDsoY c WHERE c.sendInterval = :sendInterval")
    , @NamedQuery(name = "CumulDsoY.findByThdd", query = "SELECT c FROM CumulDsoY c WHERE c.thdd = :thdd")
    , @NamedQuery(name = "CumulDsoY.findByUpTime", query = "SELECT c FROM CumulDsoY c WHERE c.upTime = :upTime")
    , @NamedQuery(name = "CumulDsoY.findByVoltageDeviation", query = "SELECT c FROM CumulDsoY c WHERE c.voltageDeviation = :voltageDeviation")
    , @NamedQuery(name = "CumulDsoY.findByIdx12hours", query = "SELECT c FROM CumulDsoY c WHERE c.idx12hours = :idx12hours")
    , @NamedQuery(name = "CumulDsoY.findByIdx15minutes", query = "SELECT c FROM CumulDsoY c WHERE c.idx15minutes = :idx15minutes")
    , @NamedQuery(name = "CumulDsoY.findByIdx1day", query = "SELECT c FROM CumulDsoY c WHERE c.idx1day = :idx1day")
    , @NamedQuery(name = "CumulDsoY.findByIdx1hour", query = "SELECT c FROM CumulDsoY c WHERE c.idx1hour = :idx1hour")
    , @NamedQuery(name = "CumulDsoY.findByIdx1month", query = "SELECT c FROM CumulDsoY c WHERE c.idx1month = :idx1month")
    , @NamedQuery(name = "CumulDsoY.findByIdx1week", query = "SELECT c FROM CumulDsoY c WHERE c.idx1week = :idx1week")
    , @NamedQuery(name = "CumulDsoY.findByIdx1year", query = "SELECT c FROM CumulDsoY c WHERE c.idx1year = :idx1year")
    , @NamedQuery(name = "CumulDsoY.findByIdx3month", query = "SELECT c FROM CumulDsoY c WHERE c.idx3month = :idx3month")
    , @NamedQuery(name = "CumulDsoY.findByIdx6hours", query = "SELECT c FROM CumulDsoY c WHERE c.idx6hours = :idx6hours")
    , @NamedQuery(name = "CumulDsoY.findByIdx6month", query = "SELECT c FROM CumulDsoY c WHERE c.idx6month = :idx6month")})
public class CumulDsoY implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        CumulDsoY other = (CumulDsoY) object;
    ...
    public String toString() {
        return "ro.siveco.cad.integridy.entities.CumulDsoY[ id=" + id + " ]";
    }
