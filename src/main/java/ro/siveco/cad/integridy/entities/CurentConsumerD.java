 ...
 */
@Entity
@Table(name = "curent_consumer_d")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "CurentConsumerD.findAll", query = "SELECT c FROM CurentConsumerD c")
    , @NamedQuery(name = "CurentConsumerD.findById", query = "SELECT c FROM CurentConsumerD c WHERE c.id = :id")
    , @NamedQuery(name = "CurentConsumerD.findByActivePow", query = "SELECT c FROM CurentConsumerD c WHERE c.activePow = :activePow")
    , @NamedQuery(name = "CurentConsumerD.findByCo2", query = "SELECT c FROM CurentConsumerD c WHERE c.co2 = :co2")
    , @NamedQuery(name = "CurentConsumerD.findByConsumedActivePow", query = "SELECT c FROM CurentConsumerD c WHERE c.consumedActivePow = :consumedActivePow")
    , @NamedQuery(name = "CurentConsumerD.findByConsumedReactivePow", query = "SELECT c FROM CurentConsumerD c WHERE c.consumedReactivePow = :consumedReactivePow")
    , @NamedQuery(name = "CurentConsumerD.findByCreatedTime", query = "SELECT c FROM CurentConsumerD c WHERE c.createdTime = :createdTime")
    , @NamedQuery(name = "CurentConsumerD.findByDayCost", query = "SELECT c FROM CurentConsumerD c WHERE c.dayCost = :dayCost")
    , @NamedQuery(name = "CurentConsumerD.findByDeviceNumber", query = "SELECT c FROM CurentConsumerD c WHERE c.deviceNumber = :deviceNumber")
    , @NamedQuery(name = "CurentConsumerD.findByDownTime", query = "SELECT c FROM CurentConsumerD c WHERE c.downTime = :downTime")
    , @NamedQuery(name = "CurentConsumerD.findByEnergyMismatch", query = "SELECT c FROM CurentConsumerD c WHERE c.energyMismatch = :energyMismatch")
    , @NamedQuery(name = "CurentConsumerD.findByEnergyMismatchRatio", query = "SELECT c FROM CurentConsumerD c WHERE c.energyMismatchRatio = :energyMismatchRatio")
    , @NamedQuery(name = "CurentConsumerD.findByNightCost", query = "SELECT c FROM CurentConsumerD c WHERE c.nightCost = :nightCost")
    , @NamedQuery(name = "CurentConsumerD.findBySaidi", query = "SELECT c FROM CurentConsumerD c WHERE c.saidi = :saidi")
    , @NamedQuery(name = "CurentConsumerD.findByPhaseVoltage", query = "SELECT c FROM CurentConsumerD c WHERE c.phaseVoltage = :phaseVoltage")
    , @NamedQuery(name = "CurentConsumerD.findByReactivePow", query = "SELECT c FROM CurentConsumerD c WHERE c.reactivePow = :reactivePow")
    , @NamedQuery(name = "CurentConsumerD.findBySendInterval", query = "SELECT c FROM CurentConsumerD c WHERE c.sendInterval = :sendInterval")
    , @NamedQuery(name = "CurentConsumerD.findByThdd", query = "SELECT c FROM CurentConsumerD c WHERE c.thdd = :thdd")
    , @NamedQuery(name = "CurentConsumerD.findByUpTime", query = "SELECT c FROM CurentConsumerD c WHERE c.upTime = :upTime")
    , @NamedQuery(name = "CurentConsumerD.findByVoltageDeviation", query = "SELECT c FROM CurentConsumerD c WHERE c.voltageDeviation = :voltageDeviation")
    , @NamedQuery(name = "CurentConsumerD.findByIdx12hours", query = "SELECT c FROM CurentConsumerD c WHERE c.idx12hours = :idx12hours")
    , @NamedQuery(name = "CurentConsumerD.findByIdx15minutes", query = "SELECT c FROM CurentConsumerD c WHERE c.idx15minutes = :idx15minutes")
    , @NamedQuery(name = "CurentConsumerD.findByIdx1day", query = "SELECT c FROM CurentConsumerD c WHERE c.idx1day = :idx1day")
    , @NamedQuery(name = "CurentConsumerD.findByIdx1hour", query = "SELECT c FROM CurentConsumerD c WHERE c.idx1hour = :idx1hour")
    , @NamedQuery(name = "CurentConsumerD.findByIdx1month", query = "SELECT c FROM CurentConsumerD c WHERE c.idx1month = :idx1month")
    , @NamedQuery(name = "CurentConsumerD.findByIdx1week", query = "SELECT c FROM CurentConsumerD c WHERE c.idx1week = :idx1week")
    , @NamedQuery(name = "CurentConsumerD.findByIdx1year", query = "SELECT c FROM CurentConsumerD c WHERE c.idx1year = :idx1year")
    , @NamedQuery(name = "CurentConsumerD.findByIdx3month", query = "SELECT c FROM CurentConsumerD c WHERE c.idx3month = :idx3month")
    , @NamedQuery(name = "CurentConsumerD.findByIdx6hours", query = "SELECT c FROM CurentConsumerD c WHERE c.idx6hours = :idx6hours")
    , @NamedQuery(name = "CurentConsumerD.findByIdx6month", query = "SELECT c FROM CurentConsumerD c WHERE c.idx6month = :idx6month")})
public class CurentConsumerD implements Serializable {
    ...
    public CurentConsumerD() {
    }

    public CurentConsumerD(Long id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        CurentConsumerD other = (CurentConsumerD) object;
    ...
    public String toString() {
        return "ro.siveco.cad.integridy.entities.CurentConsumerD[ id=" + id + " ]";
    }
