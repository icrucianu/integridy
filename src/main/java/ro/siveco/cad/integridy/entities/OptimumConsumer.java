 ...
 */
@Entity
@Table(name = "optimum_consumer")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "OptimumConsumer.findAll", query = "SELECT o FROM OptimumConsumer o")
    , @NamedQuery(name = "OptimumConsumer.findById", query = "SELECT o FROM OptimumConsumer o WHERE o.id = :id")
    , @NamedQuery(name = "OptimumConsumer.findByActivePow", query = "SELECT o FROM OptimumConsumer o WHERE o.activePow = :activePow")
    , @NamedQuery(name = "OptimumConsumer.findByCo2", query = "SELECT o FROM OptimumConsumer o WHERE o.co2 = :co2")
    , @NamedQuery(name = "OptimumConsumer.findByConsumedActivePow", query = "SELECT o FROM OptimumConsumer o WHERE o.consumedActivePow = :consumedActivePow")
    , @NamedQuery(name = "OptimumConsumer.findByConsumedReactivePow", query = "SELECT o FROM OptimumConsumer o WHERE o.consumedReactivePow = :consumedReactivePow")
    , @NamedQuery(name = "OptimumConsumer.findByCreatedTime", query = "SELECT o FROM OptimumConsumer o WHERE o.createdTime = :createdTime")
    , @NamedQuery(name = "OptimumConsumer.findByDayCost", query = "SELECT o FROM OptimumConsumer o WHERE o.dayCost = :dayCost")
    , @NamedQuery(name = "OptimumConsumer.findByDeviceNumber", query = "SELECT o FROM OptimumConsumer o WHERE o.deviceNumber = :deviceNumber")
    , @NamedQuery(name = "OptimumConsumer.findByDownTime", query = "SELECT o FROM OptimumConsumer o WHERE o.downTime = :downTime")
    , @NamedQuery(name = "OptimumConsumer.findByEnergyMismatch", query = "SELECT o FROM OptimumConsumer o WHERE o.energyMismatch = :energyMismatch")
    , @NamedQuery(name = "OptimumConsumer.findByEnergyMismatchRatio", query = "SELECT o FROM OptimumConsumer o WHERE o.energyMismatchRatio = :energyMismatchRatio")
    , @NamedQuery(name = "OptimumConsumer.findByNightCost", query = "SELECT o FROM OptimumConsumer o WHERE o.nightCost = :nightCost")
    , @NamedQuery(name = "OptimumConsumer.findBySaidi", query = "SELECT o FROM OptimumConsumer o WHERE o.saidi = :saidi")
    , @NamedQuery(name = "OptimumConsumer.findByPhaseVoltage", query = "SELECT o FROM OptimumConsumer o WHERE o.phaseVoltage = :phaseVoltage")
    , @NamedQuery(name = "OptimumConsumer.findByReactivePow", query = "SELECT o FROM OptimumConsumer o WHERE o.reactivePow = :reactivePow")
    , @NamedQuery(name = "OptimumConsumer.findBySendInterval", query = "SELECT o FROM OptimumConsumer o WHERE o.sendInterval = :sendInterval")
    , @NamedQuery(name = "OptimumConsumer.findByThdd", query = "SELECT o FROM OptimumConsumer o WHERE o.thdd = :thdd")
    , @NamedQuery(name = "OptimumConsumer.findByUpTime", query = "SELECT o FROM OptimumConsumer o WHERE o.upTime = :upTime")
    , @NamedQuery(name = "OptimumConsumer.findByVoltageDeviation", query = "SELECT o FROM OptimumConsumer o WHERE o.voltageDeviation = :voltageDeviation")
    , @NamedQuery(name = "OptimumConsumer.findByIdx12hours", query = "SELECT o FROM OptimumConsumer o WHERE o.idx12hours = :idx12hours")
    , @NamedQuery(name = "OptimumConsumer.findByIdx15minutes", query = "SELECT o FROM OptimumConsumer o WHERE o.idx15minutes = :idx15minutes")
    , @NamedQuery(name = "OptimumConsumer.findByIdx1day", query = "SELECT o FROM OptimumConsumer o WHERE o.idx1day = :idx1day")
    , @NamedQuery(name = "OptimumConsumer.findByIdx1hour", query = "SELECT o FROM OptimumConsumer o WHERE o.idx1hour = :idx1hour")
    , @NamedQuery(name = "OptimumConsumer.findByIdx1month", query = "SELECT o FROM OptimumConsumer o WHERE o.idx1month = :idx1month")
    , @NamedQuery(name = "OptimumConsumer.findByIdx1week", query = "SELECT o FROM OptimumConsumer o WHERE o.idx1week = :idx1week")
    , @NamedQuery(name = "OptimumConsumer.findByIdx1year", query = "SELECT o FROM OptimumConsumer o WHERE o.idx1year = :idx1year")
    , @NamedQuery(name = "OptimumConsumer.findByIdx3month", query = "SELECT o FROM OptimumConsumer o WHERE o.idx3month = :idx3month")
    , @NamedQuery(name = "OptimumConsumer.findByIdx6hours", query = "SELECT o FROM OptimumConsumer o WHERE o.idx6hours = :idx6hours")
    , @NamedQuery(name = "OptimumConsumer.findByIdx6month", query = "SELECT o FROM OptimumConsumer o WHERE o.idx6month = :idx6month")})
public class OptimumConsumer implements Serializable {
    ...
    public OptimumConsumer() {
    }

    public OptimumConsumer(Long id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof OptimumConsumer)) {
            return false;
        }
        OptimumConsumer other = (OptimumConsumer) object;
    ...
    public String toString() {
        return "ro.siveco.cad.integridy.entities.OptimumConsumer[ id=" + id + " ]";
    }
