 ...
 */
@Entity
@Table(name = "cumul_consumer_y")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "CumulConsumerY.findAll", query = "SELECT c FROM CumulConsumerY c")
    , @NamedQuery(name = "CumulConsumerY.findById", query = "SELECT c FROM CumulConsumerY c WHERE c.id = :id")
    , @NamedQuery(name = "CumulConsumerY.findByActivePow", query = "SELECT c FROM CumulConsumerY c WHERE c.activePow = :activePow")
    , @NamedQuery(name = "CumulConsumerY.findByCo2", query = "SELECT c FROM CumulConsumerY c WHERE c.co2 = :co2")
    , @NamedQuery(name = "CumulConsumerY.findByConsumedActivePow", query = "SELECT c FROM CumulConsumerY c WHERE c.consumedActivePow = :consumedActivePow")
    , @NamedQuery(name = "CumulConsumerY.findByConsumedReactivePow", query = "SELECT c FROM CumulConsumerY c WHERE c.consumedReactivePow = :consumedReactivePow")
    , @NamedQuery(name = "CumulConsumerY.findByCreatedTime", query = "SELECT c FROM CumulConsumerY c WHERE c.createdTime = :createdTime")
    , @NamedQuery(name = "CumulConsumerY.findByDayCost", query = "SELECT c FROM CumulConsumerY c WHERE c.dayCost = :dayCost")
    , @NamedQuery(name = "CumulConsumerY.findByDeviceNumber", query = "SELECT c FROM CumulConsumerY c WHERE c.deviceNumber = :deviceNumber")
    , @NamedQuery(name = "CumulConsumerY.findByDownTime", query = "SELECT c FROM CumulConsumerY c WHERE c.downTime = :downTime")
    , @NamedQuery(name = "CumulConsumerY.findByEnergyMismatch", query = "SELECT c FROM CumulConsumerY c WHERE c.energyMismatch = :energyMismatch")
    , @NamedQuery(name = "CumulConsumerY.findByEnergyMismatchRatio", query = "SELECT c FROM CumulConsumerY c WHERE c.energyMismatchRatio = :energyMismatchRatio")
    , @NamedQuery(name = "CumulConsumerY.findByNightCost", query = "SELECT c FROM CumulConsumerY c WHERE c.nightCost = :nightCost")
    , @NamedQuery(name = "CumulConsumerY.findBySaidi", query = "SELECT c FROM CumulConsumerY c WHERE c.saidi = :saidi")
    , @NamedQuery(name = "CumulConsumerY.findByPhaseVoltage", query = "SELECT c FROM CumulConsumerY c WHERE c.phaseVoltage = :phaseVoltage")
    , @NamedQuery(name = "CumulConsumerY.findByReactivePow", query = "SELECT c FROM CumulConsumerY c WHERE c.reactivePow = :reactivePow")
    , @NamedQuery(name = "CumulConsumerY.findBySendInterval", query = "SELECT c FROM CumulConsumerY c WHERE c.sendInterval = :sendInterval")
    , @NamedQuery(name = "CumulConsumerY.findByThdd", query = "SELECT c FROM CumulConsumerY c WHERE c.thdd = :thdd")
    , @NamedQuery(name = "CumulConsumerY.findByUpTime", query = "SELECT c FROM CumulConsumerY c WHERE c.upTime = :upTime")
    , @NamedQuery(name = "CumulConsumerY.findByVoltageDeviation", query = "SELECT c FROM CumulConsumerY c WHERE c.voltageDeviation = :voltageDeviation")
    , @NamedQuery(name = "CumulConsumerY.findByIdx12hours", query = "SELECT c FROM CumulConsumerY c WHERE c.idx12hours = :idx12hours")
    , @NamedQuery(name = "CumulConsumerY.findByIdx15minutes", query = "SELECT c FROM CumulConsumerY c WHERE c.idx15minutes = :idx15minutes")
    , @NamedQuery(name = "CumulConsumerY.findByIdx1day", query = "SELECT c FROM CumulConsumerY c WHERE c.idx1day = :idx1day")
    , @NamedQuery(name = "CumulConsumerY.findByIdx1hour", query = "SELECT c FROM CumulConsumerY c WHERE c.idx1hour = :idx1hour")
    , @NamedQuery(name = "CumulConsumerY.findByIdx1month", query = "SELECT c FROM CumulConsumerY c WHERE c.idx1month = :idx1month")
    , @NamedQuery(name = "CumulConsumerY.findByIdx1week", query = "SELECT c FROM CumulConsumerY c WHERE c.idx1week = :idx1week")
    , @NamedQuery(name = "CumulConsumerY.findByIdx1year", query = "SELECT c FROM CumulConsumerY c WHERE c.idx1year = :idx1year")
    , @NamedQuery(name = "CumulConsumerY.findByIdx3month", query = "SELECT c FROM CumulConsumerY c WHERE c.idx3month = :idx3month")
    , @NamedQuery(name = "CumulConsumerY.findByIdx6hours", query = "SELECT c FROM CumulConsumerY c WHERE c.idx6hours = :idx6hours")
    , @NamedQuery(name = "CumulConsumerY.findByIdx6month", query = "SELECT c FROM CumulConsumerY c WHERE c.idx6month = :idx6month")})
public class CumulConsumerY implements Serializable {
    ...
    public CumulConsumerY() {
    }

    public CumulConsumerY(Long id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        CumulConsumerY other = (CumulConsumerY) object;
    ...
    public String toString() {
        return "ro.siveco.cad.integridy.entities.CumulConsumerY[ id=" + id + " ]";
    }
