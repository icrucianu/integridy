...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "ConsumptionRecord.findAll", query = "SELECT c FROM ConsumptionRecord c")
    , @NamedQuery(name = "ConsumptionRecord.findById", query = "SELECT c FROM ConsumptionRecord c WHERE c.id = :id")
    , @NamedQuery(name = "ConsumptionRecord.findByActivePow", query = "SELECT c FROM ConsumptionRecord c WHERE c.activePow = :activePow")
    , @NamedQuery(name = "ConsumptionRecord.findByCo2", query = "SELECT c FROM ConsumptionRecord c WHERE c.co2 = :co2")
    , @NamedQuery(name = "ConsumptionRecord.findByConsumedActivePow", query = "SELECT c FROM ConsumptionRecord c WHERE c.consumedActivePow = :consumedActivePow")
    , @NamedQuery(name = "ConsumptionRecord.findByConsumedReactivePow", query = "SELECT c FROM ConsumptionRecord c WHERE c.consumedReactivePow = :consumedReactivePow")
    , @NamedQuery(name = "ConsumptionRecord.findByCreatedTime", query = "SELECT c FROM ConsumptionRecord c WHERE c.createdTime = :createdTime")
    , @NamedQuery(name = "ConsumptionRecord.findByDayCost", query = "SELECT c FROM ConsumptionRecord c WHERE c.dayCost = :dayCost")
    , @NamedQuery(name = "ConsumptionRecord.findByDeviceNumber", query = "SELECT c FROM ConsumptionRecord c WHERE c.deviceNumber = :deviceNumber")
    , @NamedQuery(name = "ConsumptionRecord.findByDownTime", query = "SELECT c FROM ConsumptionRecord c WHERE c.downTime = :downTime")
    , @NamedQuery(name = "ConsumptionRecord.findByEnergyMismatch", query = "SELECT c FROM ConsumptionRecord c WHERE c.energyMismatch = :energyMismatch")
    , @NamedQuery(name = "ConsumptionRecord.findByEnergyMismatchRatio", query = "SELECT c FROM ConsumptionRecord c WHERE c.energyMismatchRatio = :energyMismatchRatio")
    , @NamedQuery(name = "ConsumptionRecord.findByNightCost", query = "SELECT c FROM ConsumptionRecord c WHERE c.nightCost = :nightCost")
    , @NamedQuery(name = "ConsumptionRecord.findBySaidi", query = "SELECT c FROM ConsumptionRecord c WHERE c.saidi = :saidi")
    , @NamedQuery(name = "ConsumptionRecord.findByPhaseVoltage", query = "SELECT c FROM ConsumptionRecord c WHERE c.phaseVoltage = :phaseVoltage")
    , @NamedQuery(name = "ConsumptionRecord.findByReactivePow", query = "SELECT c FROM ConsumptionRecord c WHERE c.reactivePow = :reactivePow")
    , @NamedQuery(name = "ConsumptionRecord.findBySendInterval", query = "SELECT c FROM ConsumptionRecord c WHERE c.sendInterval = :sendInterval")
    , @NamedQuery(name = "ConsumptionRecord.findByThdd", query = "SELECT c FROM ConsumptionRecord c WHERE c.thdd = :thdd")
    , @NamedQuery(name = "ConsumptionRecord.findByUpTime", query = "SELECT c FROM ConsumptionRecord c WHERE c.upTime = :upTime")
    , @NamedQuery(name = "ConsumptionRecord.findByVoltageDeviation", query = "SELECT c FROM ConsumptionRecord c WHERE c.voltageDeviation = :voltageDeviation")
    , @NamedQuery(name = "ConsumptionRecord.findByIdx12hours", query = "SELECT c FROM ConsumptionRecord c WHERE c.idx12hours = :idx12hours")
    , @NamedQuery(name = "ConsumptionRecord.findByIdx15minutes", query = "SELECT c FROM ConsumptionRecord c WHERE c.idx15minutes = :idx15minutes")
    , @NamedQuery(name = "ConsumptionRecord.findByIdx1day", query = "SELECT c FROM ConsumptionRecord c WHERE c.idx1day = :idx1day")
    , @NamedQuery(name = "ConsumptionRecord.findByIdx1hour", query = "SELECT c FROM ConsumptionRecord c WHERE c.idx1hour = :idx1hour")
    , @NamedQuery(name = "ConsumptionRecord.findByIdx1month", query = "SELECT c FROM ConsumptionRecord c WHERE c.idx1month = :idx1month")
    , @NamedQuery(name = "ConsumptionRecord.findByIdx1week", query = "SELECT c FROM ConsumptionRecord c WHERE c.idx1week = :idx1week")
    , @NamedQuery(name = "ConsumptionRecord.findByIdx1year", query = "SELECT c FROM ConsumptionRecord c WHERE c.idx1year = :idx1year")
    , @NamedQuery(name = "ConsumptionRecord.findByIdx3month", query = "SELECT c FROM ConsumptionRecord c WHERE c.idx3month = :idx3month")
    , @NamedQuery(name = "ConsumptionRecord.findByIdx6hours", query = "SELECT c FROM ConsumptionRecord c WHERE c.idx6hours = :idx6hours")
    , @NamedQuery(name = "ConsumptionRecord.findByIdx6month", query = "SELECT c FROM ConsumptionRecord c WHERE c.idx6month = :idx6month")})
public class ConsumptionRecord implements Serializable {
    ...
    public ConsumptionRecord(Long id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        ConsumptionRecord other = (ConsumptionRecord) object;
    ...
    public String toString() {
        return "ro.siveco.cad.integridy.entities.ConsumptionRecord[ id=" + id + " ]";
    }
