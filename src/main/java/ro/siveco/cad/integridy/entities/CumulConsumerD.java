 ...
 */
@Entity
@Table(name = "cumul_consumer_d")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "CumulConsumerD.findAll", query = "SELECT c FROM CumulConsumerD c")
    , @NamedQuery(name = "CumulConsumerD.findById", query = "SELECT c FROM CumulConsumerD c WHERE c.id = :id")
    , @NamedQuery(name = "CumulConsumerD.findByActivePow", query = "SELECT c FROM CumulConsumerD c WHERE c.activePow = :activePow")
    , @NamedQuery(name = "CumulConsumerD.findByCo2", query = "SELECT c FROM CumulConsumerD c WHERE c.co2 = :co2")
    , @NamedQuery(name = "CumulConsumerD.findByConsumedActivePow", query = "SELECT c FROM CumulConsumerD c WHERE c.consumedActivePow = :consumedActivePow")
    , @NamedQuery(name = "CumulConsumerD.findByConsumedReactivePow", query = "SELECT c FROM CumulConsumerD c WHERE c.consumedReactivePow = :consumedReactivePow")
    , @NamedQuery(name = "CumulConsumerD.findByCreatedTime", query = "SELECT c FROM CumulConsumerD c WHERE c.createdTime = :createdTime")
    , @NamedQuery(name = "CumulConsumerD.findByDayCost", query = "SELECT c FROM CumulConsumerD c WHERE c.dayCost = :dayCost")
    , @NamedQuery(name = "CumulConsumerD.findByDeviceNumber", query = "SELECT c FROM CumulConsumerD c WHERE c.deviceNumber = :deviceNumber")
    , @NamedQuery(name = "CumulConsumerD.findByDownTime", query = "SELECT c FROM CumulConsumerD c WHERE c.downTime = :downTime")
    , @NamedQuery(name = "CumulConsumerD.findByEnergyMismatch", query = "SELECT c FROM CumulConsumerD c WHERE c.energyMismatch = :energyMismatch")
    , @NamedQuery(name = "CumulConsumerD.findByEnergyMismatchRatio", query = "SELECT c FROM CumulConsumerD c WHERE c.energyMismatchRatio = :energyMismatchRatio")
    , @NamedQuery(name = "CumulConsumerD.findByNightCost", query = "SELECT c FROM CumulConsumerD c WHERE c.nightCost = :nightCost")
    , @NamedQuery(name = "CumulConsumerD.findBySaidi", query = "SELECT c FROM CumulConsumerD c WHERE c.saidi = :saidi")
    , @NamedQuery(name = "CumulConsumerD.findByPhaseVoltage", query = "SELECT c FROM CumulConsumerD c WHERE c.phaseVoltage = :phaseVoltage")
    , @NamedQuery(name = "CumulConsumerD.findByReactivePow", query = "SELECT c FROM CumulConsumerD c WHERE c.reactivePow = :reactivePow")
    , @NamedQuery(name = "CumulConsumerD.findBySendInterval", query = "SELECT c FROM CumulConsumerD c WHERE c.sendInterval = :sendInterval")
    , @NamedQuery(name = "CumulConsumerD.findByThdd", query = "SELECT c FROM CumulConsumerD c WHERE c.thdd = :thdd")
    , @NamedQuery(name = "CumulConsumerD.findByUpTime", query = "SELECT c FROM CumulConsumerD c WHERE c.upTime = :upTime")
    , @NamedQuery(name = "CumulConsumerD.findByVoltageDeviation", query = "SELECT c FROM CumulConsumerD c WHERE c.voltageDeviation = :voltageDeviation")
    , @NamedQuery(name = "CumulConsumerD.findByIdx12hours", query = "SELECT c FROM CumulConsumerD c WHERE c.idx12hours = :idx12hours")
    , @NamedQuery(name = "CumulConsumerD.findByIdx15minutes", query = "SELECT c FROM CumulConsumerD c WHERE c.idx15minutes = :idx15minutes")
    , @NamedQuery(name = "CumulConsumerD.findByIdx1day", query = "SELECT c FROM CumulConsumerD c WHERE c.idx1day = :idx1day")
    , @NamedQuery(name = "CumulConsumerD.findByIdx1hour", query = "SELECT c FROM CumulConsumerD c WHERE c.idx1hour = :idx1hour")
    , @NamedQuery(name = "CumulConsumerD.findByIdx1month", query = "SELECT c FROM CumulConsumerD c WHERE c.idx1month = :idx1month")
    , @NamedQuery(name = "CumulConsumerD.findByIdx1week", query = "SELECT c FROM CumulConsumerD c WHERE c.idx1week = :idx1week")
    , @NamedQuery(name = "CumulConsumerD.findByIdx1year", query = "SELECT c FROM CumulConsumerD c WHERE c.idx1year = :idx1year")
    , @NamedQuery(name = "CumulConsumerD.findByIdx3month", query = "SELECT c FROM CumulConsumerD c WHERE c.idx3month = :idx3month")
    , @NamedQuery(name = "CumulConsumerD.findByIdx6hours", query = "SELECT c FROM CumulConsumerD c WHERE c.idx6hours = :idx6hours")
    , @NamedQuery(name = "CumulConsumerD.findByIdx6month", query = "SELECT c FROM CumulConsumerD c WHERE c.idx6month = :idx6month")})
public class CumulConsumerD implements Serializable {
    ...
    public CumulConsumerD() {
    }

    public CumulConsumerD(Long id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        CumulConsumerD other = (CumulConsumerD) object;
    ...
    public String toString() {
        return "ro.siveco.cad.integridy.entities.CumulConsumerD[ id=" + id + " ]";
    }
