 ...
 */
@Entity
@Table(name = "curent_dso_d")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "CurentDsoD.findAll", query = "SELECT c FROM CurentDsoD c")
    , @NamedQuery(name = "CurentDsoD.findById", query = "SELECT c FROM CurentDsoD c WHERE c.id = :id")
    , @NamedQuery(name = "CurentDsoD.findByActivePow", query = "SELECT c FROM CurentDsoD c WHERE c.activePow = :activePow")
    , @NamedQuery(name = "CurentDsoD.findByCo2", query = "SELECT c FROM CurentDsoD c WHERE c.co2 = :co2")
    , @NamedQuery(name = "CurentDsoD.findByConsumedActivePow", query = "SELECT c FROM CurentDsoD c WHERE c.consumedActivePow = :consumedActivePow")
    , @NamedQuery(name = "CurentDsoD.findByConsumedReactivePow", query = "SELECT c FROM CurentDsoD c WHERE c.consumedReactivePow = :consumedReactivePow")
    , @NamedQuery(name = "CurentDsoD.findByCreatedTime", query = "SELECT c FROM CurentDsoD c WHERE c.createdTime = :createdTime")
    , @NamedQuery(name = "CurentDsoD.findByDayCost", query = "SELECT c FROM CurentDsoD c WHERE c.dayCost = :dayCost")
    , @NamedQuery(name = "CurentDsoD.findByDeviceNumber", query = "SELECT c FROM CurentDsoD c WHERE c.deviceNumber = :deviceNumber")
    , @NamedQuery(name = "CurentDsoD.findByDownTime", query = "SELECT c FROM CurentDsoD c WHERE c.downTime = :downTime")
    , @NamedQuery(name = "CurentDsoD.findByEnergyMismatch", query = "SELECT c FROM CurentDsoD c WHERE c.energyMismatch = :energyMismatch")
    , @NamedQuery(name = "CurentDsoD.findByEnergyMismatchRatio", query = "SELECT c FROM CurentDsoD c WHERE c.energyMismatchRatio = :energyMismatchRatio")
    , @NamedQuery(name = "CurentDsoD.findByNightCost", query = "SELECT c FROM CurentDsoD c WHERE c.nightCost = :nightCost")
    , @NamedQuery(name = "CurentDsoD.findBySaidi", query = "SELECT c FROM CurentDsoD c WHERE c.saidi = :saidi")
    , @NamedQuery(name = "CurentDsoD.findByPhaseVoltage", query = "SELECT c FROM CurentDsoD c WHERE c.phaseVoltage = :phaseVoltage")
    , @NamedQuery(name = "CurentDsoD.findByReactivePow", query = "SELECT c FROM CurentDsoD c WHERE c.reactivePow = :reactivePow")
    , @NamedQuery(name = "CurentDsoD.findBySendInterval", query = "SELECT c FROM CurentDsoD c WHERE c.sendInterval = :sendInterval")
    , @NamedQuery(name = "CurentDsoD.findByThdd", query = "SELECT c FROM CurentDsoD c WHERE c.thdd = :thdd")
    , @NamedQuery(name = "CurentDsoD.findByUpTime", query = "SELECT c FROM CurentDsoD c WHERE c.upTime = :upTime")
    , @NamedQuery(name = "CurentDsoD.findByVoltageDeviation", query = "SELECT c FROM CurentDsoD c WHERE c.voltageDeviation = :voltageDeviation")
    , @NamedQuery(name = "CurentDsoD.findByIdx12hours", query = "SELECT c FROM CurentDsoD c WHERE c.idx12hours = :idx12hours")
    , @NamedQuery(name = "CurentDsoD.findByIdx15minutes", query = "SELECT c FROM CurentDsoD c WHERE c.idx15minutes = :idx15minutes")
    , @NamedQuery(name = "CurentDsoD.findByIdx1day", query = "SELECT c FROM CurentDsoD c WHERE c.idx1day = :idx1day")
    , @NamedQuery(name = "CurentDsoD.findByIdx1hour", query = "SELECT c FROM CurentDsoD c WHERE c.idx1hour = :idx1hour")
    , @NamedQuery(name = "CurentDsoD.findByIdx1month", query = "SELECT c FROM CurentDsoD c WHERE c.idx1month = :idx1month")
    , @NamedQuery(name = "CurentDsoD.findByIdx1week", query = "SELECT c FROM CurentDsoD c WHERE c.idx1week = :idx1week")
    , @NamedQuery(name = "CurentDsoD.findByIdx1year", query = "SELECT c FROM CurentDsoD c WHERE c.idx1year = :idx1year")
    , @NamedQuery(name = "CurentDsoD.findByIdx3month", query = "SELECT c FROM CurentDsoD c WHERE c.idx3month = :idx3month")
    , @NamedQuery(name = "CurentDsoD.findByIdx6hours", query = "SELECT c FROM CurentDsoD c WHERE c.idx6hours = :idx6hours")
    , @NamedQuery(name = "CurentDsoD.findByIdx6month", query = "SELECT c FROM CurentDsoD c WHERE c.idx6month = :idx6month")})
public class CurentDsoD implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        CurentDsoD other = (CurentDsoD) object;
    ...
    public String toString() {
        return "ro.siveco.cad.integridy.entities.CurentDsoD[ id=" + id + " ]";
    }
