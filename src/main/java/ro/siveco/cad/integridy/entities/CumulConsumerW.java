 ...
 */
@Entity
@Table(name = "cumul_consumer_w")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "CumulConsumerW.findAll", query = "SELECT c FROM CumulConsumerW c")
    , @NamedQuery(name = "CumulConsumerW.findById", query = "SELECT c FROM CumulConsumerW c WHERE c.id = :id")
    , @NamedQuery(name = "CumulConsumerW.findByActivePow", query = "SELECT c FROM CumulConsumerW c WHERE c.activePow = :activePow")
    , @NamedQuery(name = "CumulConsumerW.findByCo2", query = "SELECT c FROM CumulConsumerW c WHERE c.co2 = :co2")
    , @NamedQuery(name = "CumulConsumerW.findByConsumedActivePow", query = "SELECT c FROM CumulConsumerW c WHERE c.consumedActivePow = :consumedActivePow")
    , @NamedQuery(name = "CumulConsumerW.findByConsumedReactivePow", query = "SELECT c FROM CumulConsumerW c WHERE c.consumedReactivePow = :consumedReactivePow")
    , @NamedQuery(name = "CumulConsumerW.findByCreatedTime", query = "SELECT c FROM CumulConsumerW c WHERE c.createdTime = :createdTime")
    , @NamedQuery(name = "CumulConsumerW.findByDayCost", query = "SELECT c FROM CumulConsumerW c WHERE c.dayCost = :dayCost")
    , @NamedQuery(name = "CumulConsumerW.findByDeviceNumber", query = "SELECT c FROM CumulConsumerW c WHERE c.deviceNumber = :deviceNumber")
    , @NamedQuery(name = "CumulConsumerW.findByDownTime", query = "SELECT c FROM CumulConsumerW c WHERE c.downTime = :downTime")
    , @NamedQuery(name = "CumulConsumerW.findByEnergyMismatch", query = "SELECT c FROM CumulConsumerW c WHERE c.energyMismatch = :energyMismatch")
    , @NamedQuery(name = "CumulConsumerW.findByEnergyMismatchRatio", query = "SELECT c FROM CumulConsumerW c WHERE c.energyMismatchRatio = :energyMismatchRatio")
    , @NamedQuery(name = "CumulConsumerW.findByNightCost", query = "SELECT c FROM CumulConsumerW c WHERE c.nightCost = :nightCost")
    , @NamedQuery(name = "CumulConsumerW.findBySaidi", query = "SELECT c FROM CumulConsumerW c WHERE c.saidi = :saidi")
    , @NamedQuery(name = "CumulConsumerW.findByPhaseVoltage", query = "SELECT c FROM CumulConsumerW c WHERE c.phaseVoltage = :phaseVoltage")
    , @NamedQuery(name = "CumulConsumerW.findByReactivePow", query = "SELECT c FROM CumulConsumerW c WHERE c.reactivePow = :reactivePow")
    , @NamedQuery(name = "CumulConsumerW.findBySendInterval", query = "SELECT c FROM CumulConsumerW c WHERE c.sendInterval = :sendInterval")
    , @NamedQuery(name = "CumulConsumerW.findByThdd", query = "SELECT c FROM CumulConsumerW c WHERE c.thdd = :thdd")
    , @NamedQuery(name = "CumulConsumerW.findByUpTime", query = "SELECT c FROM CumulConsumerW c WHERE c.upTime = :upTime")
    , @NamedQuery(name = "CumulConsumerW.findByVoltageDeviation", query = "SELECT c FROM CumulConsumerW c WHERE c.voltageDeviation = :voltageDeviation")
    , @NamedQuery(name = "CumulConsumerW.findByIdx12hours", query = "SELECT c FROM CumulConsumerW c WHERE c.idx12hours = :idx12hours")
    , @NamedQuery(name = "CumulConsumerW.findByIdx15minutes", query = "SELECT c FROM CumulConsumerW c WHERE c.idx15minutes = :idx15minutes")
    , @NamedQuery(name = "CumulConsumerW.findByIdx1day", query = "SELECT c FROM CumulConsumerW c WHERE c.idx1day = :idx1day")
    , @NamedQuery(name = "CumulConsumerW.findByIdx1hour", query = "SELECT c FROM CumulConsumerW c WHERE c.idx1hour = :idx1hour")
    , @NamedQuery(name = "CumulConsumerW.findByIdx1month", query = "SELECT c FROM CumulConsumerW c WHERE c.idx1month = :idx1month")
    , @NamedQuery(name = "CumulConsumerW.findByIdx1week", query = "SELECT c FROM CumulConsumerW c WHERE c.idx1week = :idx1week")
    , @NamedQuery(name = "CumulConsumerW.findByIdx1year", query = "SELECT c FROM CumulConsumerW c WHERE c.idx1year = :idx1year")
    , @NamedQuery(name = "CumulConsumerW.findByIdx3month", query = "SELECT c FROM CumulConsumerW c WHERE c.idx3month = :idx3month")
    , @NamedQuery(name = "CumulConsumerW.findByIdx6hours", query = "SELECT c FROM CumulConsumerW c WHERE c.idx6hours = :idx6hours")
    , @NamedQuery(name = "CumulConsumerW.findByIdx6month", query = "SELECT c FROM CumulConsumerW c WHERE c.idx6month = :idx6month")})
public class CumulConsumerW implements Serializable {
    ...
    public CumulConsumerW() {
    }

    public CumulConsumerW(Long id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        CumulConsumerW other = (CumulConsumerW) object;
    ...
    public String toString() {
        return "ro.siveco.cad.integridy.entities.CumulConsumerW[ id=" + id + " ]";
    }
