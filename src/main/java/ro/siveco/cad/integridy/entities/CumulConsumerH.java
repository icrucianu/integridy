 ...
 */
@Entity
@Table(name = "cumul_consumer_h")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "CumulConsumerH.findAll", query = "SELECT c FROM CumulConsumerH c")
    , @NamedQuery(name = "CumulConsumerH.findById", query = "SELECT c FROM CumulConsumerH c WHERE c.id = :id")
    , @NamedQuery(name = "CumulConsumerH.findByActivePow", query = "SELECT c FROM CumulConsumerH c WHERE c.activePow = :activePow")
    , @NamedQuery(name = "CumulConsumerH.findByCo2", query = "SELECT c FROM CumulConsumerH c WHERE c.co2 = :co2")
    , @NamedQuery(name = "CumulConsumerH.findByConsumedActivePow", query = "SELECT c FROM CumulConsumerH c WHERE c.consumedActivePow = :consumedActivePow")
    , @NamedQuery(name = "CumulConsumerH.findByConsumedReactivePow", query = "SELECT c FROM CumulConsumerH c WHERE c.consumedReactivePow = :consumedReactivePow")
    , @NamedQuery(name = "CumulConsumerH.findByCreatedTime", query = "SELECT c FROM CumulConsumerH c WHERE c.createdTime = :createdTime")
    , @NamedQuery(name = "CumulConsumerH.findByDayCost", query = "SELECT c FROM CumulConsumerH c WHERE c.dayCost = :dayCost")
    , @NamedQuery(name = "CumulConsumerH.findByDeviceNumber", query = "SELECT c FROM CumulConsumerH c WHERE c.deviceNumber = :deviceNumber")
    , @NamedQuery(name = "CumulConsumerH.findByDownTime", query = "SELECT c FROM CumulConsumerH c WHERE c.downTime = :downTime")
    , @NamedQuery(name = "CumulConsumerH.findByEnergyMismatch", query = "SELECT c FROM CumulConsumerH c WHERE c.energyMismatch = :energyMismatch")
    , @NamedQuery(name = "CumulConsumerH.findByEnergyMismatchRatio", query = "SELECT c FROM CumulConsumerH c WHERE c.energyMismatchRatio = :energyMismatchRatio")
    , @NamedQuery(name = "CumulConsumerH.findByNightCost", query = "SELECT c FROM CumulConsumerH c WHERE c.nightCost = :nightCost")
    , @NamedQuery(name = "CumulConsumerH.findBySaidi", query = "SELECT c FROM CumulConsumerH c WHERE c.saidi = :saidi")
    , @NamedQuery(name = "CumulConsumerH.findByPhaseVoltage", query = "SELECT c FROM CumulConsumerH c WHERE c.phaseVoltage = :phaseVoltage")
    , @NamedQuery(name = "CumulConsumerH.findByReactivePow", query = "SELECT c FROM CumulConsumerH c WHERE c.reactivePow = :reactivePow")
    , @NamedQuery(name = "CumulConsumerH.findBySendInterval", query = "SELECT c FROM CumulConsumerH c WHERE c.sendInterval = :sendInterval")
    , @NamedQuery(name = "CumulConsumerH.findByThdd", query = "SELECT c FROM CumulConsumerH c WHERE c.thdd = :thdd")
    , @NamedQuery(name = "CumulConsumerH.findByUpTime", query = "SELECT c FROM CumulConsumerH c WHERE c.upTime = :upTime")
    , @NamedQuery(name = "CumulConsumerH.findByVoltageDeviation", query = "SELECT c FROM CumulConsumerH c WHERE c.voltageDeviation = :voltageDeviation")
    , @NamedQuery(name = "CumulConsumerH.findByIdx12hours", query = "SELECT c FROM CumulConsumerH c WHERE c.idx12hours = :idx12hours")
    , @NamedQuery(name = "CumulConsumerH.findByIdx15minutes", query = "SELECT c FROM CumulConsumerH c WHERE c.idx15minutes = :idx15minutes")
    , @NamedQuery(name = "CumulConsumerH.findByIdx1day", query = "SELECT c FROM CumulConsumerH c WHERE c.idx1day = :idx1day")
    , @NamedQuery(name = "CumulConsumerH.findByIdx1hour", query = "SELECT c FROM CumulConsumerH c WHERE c.idx1hour = :idx1hour")
    , @NamedQuery(name = "CumulConsumerH.findByIdx1month", query = "SELECT c FROM CumulConsumerH c WHERE c.idx1month = :idx1month")
    , @NamedQuery(name = "CumulConsumerH.findByIdx1week", query = "SELECT c FROM CumulConsumerH c WHERE c.idx1week = :idx1week")
    , @NamedQuery(name = "CumulConsumerH.findByIdx1year", query = "SELECT c FROM CumulConsumerH c WHERE c.idx1year = :idx1year")
    , @NamedQuery(name = "CumulConsumerH.findByIdx3month", query = "SELECT c FROM CumulConsumerH c WHERE c.idx3month = :idx3month")
    , @NamedQuery(name = "CumulConsumerH.findByIdx6hours", query = "SELECT c FROM CumulConsumerH c WHERE c.idx6hours = :idx6hours")
    , @NamedQuery(name = "CumulConsumerH.findByIdx6month", query = "SELECT c FROM CumulConsumerH c WHERE c.idx6month = :idx6month")})
public class CumulConsumerH implements Serializable {
    ...
    public CumulConsumerH() {
    }

    public CumulConsumerH(Long id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CumulConsumerH)) {
            return false;
        }
        CumulConsumerH other = (CumulConsumerH) object;
    ...
    public String toString() {
        return "ro.siveco.cad.integridy.entities.CumulConsumerH[ id=" + id + " ]";
    }
