 ...
 */
@Entity
@Table(name = "cumul_consumer_m")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "CumulConsumerM.findAll", query = "SELECT c FROM CumulConsumerM c")
    , @NamedQuery(name = "CumulConsumerM.findById", query = "SELECT c FROM CumulConsumerM c WHERE c.id = :id")
    , @NamedQuery(name = "CumulConsumerM.findByActivePow", query = "SELECT c FROM CumulConsumerM c WHERE c.activePow = :activePow")
    , @NamedQuery(name = "CumulConsumerM.findByCo2", query = "SELECT c FROM CumulConsumerM c WHERE c.co2 = :co2")
    , @NamedQuery(name = "CumulConsumerM.findByConsumedActivePow", query = "SELECT c FROM CumulConsumerM c WHERE c.consumedActivePow = :consumedActivePow")
    , @NamedQuery(name = "CumulConsumerM.findByConsumedReactivePow", query = "SELECT c FROM CumulConsumerM c WHERE c.consumedReactivePow = :consumedReactivePow")
    , @NamedQuery(name = "CumulConsumerM.findByCreatedTime", query = "SELECT c FROM CumulConsumerM c WHERE c.createdTime = :createdTime")
    , @NamedQuery(name = "CumulConsumerM.findByDayCost", query = "SELECT c FROM CumulConsumerM c WHERE c.dayCost = :dayCost")
    , @NamedQuery(name = "CumulConsumerM.findByDeviceNumber", query = "SELECT c FROM CumulConsumerM c WHERE c.deviceNumber = :deviceNumber")
    , @NamedQuery(name = "CumulConsumerM.findByDownTime", query = "SELECT c FROM CumulConsumerM c WHERE c.downTime = :downTime")
    , @NamedQuery(name = "CumulConsumerM.findByEnergyMismatch", query = "SELECT c FROM CumulConsumerM c WHERE c.energyMismatch = :energyMismatch")
    , @NamedQuery(name = "CumulConsumerM.findByEnergyMismatchRatio", query = "SELECT c FROM CumulConsumerM c WHERE c.energyMismatchRatio = :energyMismatchRatio")
    , @NamedQuery(name = "CumulConsumerM.findByNightCost", query = "SELECT c FROM CumulConsumerM c WHERE c.nightCost = :nightCost")
    , @NamedQuery(name = "CumulConsumerM.findBySaidi", query = "SELECT c FROM CumulConsumerM c WHERE c.saidi = :saidi")
    , @NamedQuery(name = "CumulConsumerM.findByPhaseVoltage", query = "SELECT c FROM CumulConsumerM c WHERE c.phaseVoltage = :phaseVoltage")
    , @NamedQuery(name = "CumulConsumerM.findByReactivePow", query = "SELECT c FROM CumulConsumerM c WHERE c.reactivePow = :reactivePow")
    , @NamedQuery(name = "CumulConsumerM.findBySendInterval", query = "SELECT c FROM CumulConsumerM c WHERE c.sendInterval = :sendInterval")
    , @NamedQuery(name = "CumulConsumerM.findByThdd", query = "SELECT c FROM CumulConsumerM c WHERE c.thdd = :thdd")
    , @NamedQuery(name = "CumulConsumerM.findByUpTime", query = "SELECT c FROM CumulConsumerM c WHERE c.upTime = :upTime")
    , @NamedQuery(name = "CumulConsumerM.findByVoltageDeviation", query = "SELECT c FROM CumulConsumerM c WHERE c.voltageDeviation = :voltageDeviation")
    , @NamedQuery(name = "CumulConsumerM.findByIdx12hours", query = "SELECT c FROM CumulConsumerM c WHERE c.idx12hours = :idx12hours")
    , @NamedQuery(name = "CumulConsumerM.findByIdx15minutes", query = "SELECT c FROM CumulConsumerM c WHERE c.idx15minutes = :idx15minutes")
    , @NamedQuery(name = "CumulConsumerM.findByIdx1day", query = "SELECT c FROM CumulConsumerM c WHERE c.idx1day = :idx1day")
    , @NamedQuery(name = "CumulConsumerM.findByIdx1hour", query = "SELECT c FROM CumulConsumerM c WHERE c.idx1hour = :idx1hour")
    , @NamedQuery(name = "CumulConsumerM.findByIdx1month", query = "SELECT c FROM CumulConsumerM c WHERE c.idx1month = :idx1month")
    , @NamedQuery(name = "CumulConsumerM.findByIdx1week", query = "SELECT c FROM CumulConsumerM c WHERE c.idx1week = :idx1week")
    , @NamedQuery(name = "CumulConsumerM.findByIdx1year", query = "SELECT c FROM CumulConsumerM c WHERE c.idx1year = :idx1year")
    , @NamedQuery(name = "CumulConsumerM.findByIdx3month", query = "SELECT c FROM CumulConsumerM c WHERE c.idx3month = :idx3month")
    , @NamedQuery(name = "CumulConsumerM.findByIdx6hours", query = "SELECT c FROM CumulConsumerM c WHERE c.idx6hours = :idx6hours")
    , @NamedQuery(name = "CumulConsumerM.findByIdx6month", query = "SELECT c FROM CumulConsumerM c WHERE c.idx6month = :idx6month")})
public class CumulConsumerM implements Serializable {
    ...
    public CumulConsumerM() {
    }

    public CumulConsumerM(Long id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        CumulConsumerM other = (CumulConsumerM) object;
    ...
    public String toString() {
        return "ro.siveco.cad.integridy.entities.CumulConsumerM[ id=" + id + " ]";
    }
