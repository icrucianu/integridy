 ...
 */
@Entity
@Table(name = "forecast_consumer")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "ForecastConsumer.findAll", query = "SELECT f FROM ForecastConsumer f")
    , @NamedQuery(name = "ForecastConsumer.findById", query = "SELECT f FROM ForecastConsumer f WHERE f.id = :id")
    , @NamedQuery(name = "ForecastConsumer.findByActivePow", query = "SELECT f FROM ForecastConsumer f WHERE f.activePow = :activePow")
    , @NamedQuery(name = "ForecastConsumer.findByCo2", query = "SELECT f FROM ForecastConsumer f WHERE f.co2 = :co2")
    , @NamedQuery(name = "ForecastConsumer.findByConsumedActivePow", query = "SELECT f FROM ForecastConsumer f WHERE f.consumedActivePow = :consumedActivePow")
    , @NamedQuery(name = "ForecastConsumer.findByConsumedReactivePow", query = "SELECT f FROM ForecastConsumer f WHERE f.consumedReactivePow = :consumedReactivePow")
    , @NamedQuery(name = "ForecastConsumer.findByCreatedTime", query = "SELECT f FROM ForecastConsumer f WHERE f.createdTime = :createdTime")
    , @NamedQuery(name = "ForecastConsumer.findByDayCost", query = "SELECT f FROM ForecastConsumer f WHERE f.dayCost = :dayCost")
    , @NamedQuery(name = "ForecastConsumer.findByDeviceNumber", query = "SELECT f FROM ForecastConsumer f WHERE f.deviceNumber = :deviceNumber")
    , @NamedQuery(name = "ForecastConsumer.findByDownTime", query = "SELECT f FROM ForecastConsumer f WHERE f.downTime = :downTime")
    , @NamedQuery(name = "ForecastConsumer.findByEnergyMismatch", query = "SELECT f FROM ForecastConsumer f WHERE f.energyMismatch = :energyMismatch")
    , @NamedQuery(name = "ForecastConsumer.findByEnergyMismatchRatio", query = "SELECT f FROM ForecastConsumer f WHERE f.energyMismatchRatio = :energyMismatchRatio")
    , @NamedQuery(name = "ForecastConsumer.findByNightCost", query = "SELECT f FROM ForecastConsumer f WHERE f.nightCost = :nightCost")
    , @NamedQuery(name = "ForecastConsumer.findBySaidi", query = "SELECT f FROM ForecastConsumer f WHERE f.saidi = :saidi")
    , @NamedQuery(name = "ForecastConsumer.findByPhaseVoltage", query = "SELECT f FROM ForecastConsumer f WHERE f.phaseVoltage = :phaseVoltage")
    , @NamedQuery(name = "ForecastConsumer.findByReactivePow", query = "SELECT f FROM ForecastConsumer f WHERE f.reactivePow = :reactivePow")
    , @NamedQuery(name = "ForecastConsumer.findBySendInterval", query = "SELECT f FROM ForecastConsumer f WHERE f.sendInterval = :sendInterval")
    , @NamedQuery(name = "ForecastConsumer.findByThdd", query = "SELECT f FROM ForecastConsumer f WHERE f.thdd = :thdd")
    , @NamedQuery(name = "ForecastConsumer.findByUpTime", query = "SELECT f FROM ForecastConsumer f WHERE f.upTime = :upTime")
    , @NamedQuery(name = "ForecastConsumer.findByVoltageDeviation", query = "SELECT f FROM ForecastConsumer f WHERE f.voltageDeviation = :voltageDeviation")
    , @NamedQuery(name = "ForecastConsumer.findByIdx12hours", query = "SELECT f FROM ForecastConsumer f WHERE f.idx12hours = :idx12hours")
    , @NamedQuery(name = "ForecastConsumer.findByIdx15minutes", query = "SELECT f FROM ForecastConsumer f WHERE f.idx15minutes = :idx15minutes")
    , @NamedQuery(name = "ForecastConsumer.findByIdx1day", query = "SELECT f FROM ForecastConsumer f WHERE f.idx1day = :idx1day")
    , @NamedQuery(name = "ForecastConsumer.findByIdx1hour", query = "SELECT f FROM ForecastConsumer f WHERE f.idx1hour = :idx1hour")
    , @NamedQuery(name = "ForecastConsumer.findByIdx1month", query = "SELECT f FROM ForecastConsumer f WHERE f.idx1month = :idx1month")
    , @NamedQuery(name = "ForecastConsumer.findByIdx1week", query = "SELECT f FROM ForecastConsumer f WHERE f.idx1week = :idx1week")
    , @NamedQuery(name = "ForecastConsumer.findByIdx1year", query = "SELECT f FROM ForecastConsumer f WHERE f.idx1year = :idx1year")
    , @NamedQuery(name = "ForecastConsumer.findByIdx3month", query = "SELECT f FROM ForecastConsumer f WHERE f.idx3month = :idx3month")
    , @NamedQuery(name = "ForecastConsumer.findByIdx6hours", query = "SELECT f FROM ForecastConsumer f WHERE f.idx6hours = :idx6hours")
    , @NamedQuery(name = "ForecastConsumer.findByIdx6month", query = "SELECT f FROM ForecastConsumer f WHERE f.idx6month = :idx6month")})
public class ForecastConsumer implements Serializable {
    ...
    public ForecastConsumer() {
    }

    public ForecastConsumer(Long id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        ForecastConsumer other = (ForecastConsumer) object;
    ...
    public String toString() {
        return "ro.siveco.cad.integridy.entities.ForecastConsumer[ id=" + id + " ]";
    }
