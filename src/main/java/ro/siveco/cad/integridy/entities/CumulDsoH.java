 ...
 */
@Entity
@Table(name = "cumul_dso_h")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "CumulDsoH.findAll", query = "SELECT c FROM CumulDsoH c")
    , @NamedQuery(name = "CumulDsoH.findById", query = "SELECT c FROM CumulDsoH c WHERE c.id = :id")
    , @NamedQuery(name = "CumulDsoH.findByActivePow", query = "SELECT c FROM CumulDsoH c WHERE c.activePow = :activePow")
    , @NamedQuery(name = "CumulDsoH.findByCo2", query = "SELECT c FROM CumulDsoH c WHERE c.co2 = :co2")
    , @NamedQuery(name = "CumulDsoH.findByConsumedActivePow", query = "SELECT c FROM CumulDsoH c WHERE c.consumedActivePow = :consumedActivePow")
    , @NamedQuery(name = "CumulDsoH.findByConsumedReactivePow", query = "SELECT c FROM CumulDsoH c WHERE c.consumedReactivePow = :consumedReactivePow")
    , @NamedQuery(name = "CumulDsoH.findByCreatedTime", query = "SELECT c FROM CumulDsoH c WHERE c.createdTime = :createdTime")
    , @NamedQuery(name = "CumulDsoH.findByDayCost", query = "SELECT c FROM CumulDsoH c WHERE c.dayCost = :dayCost")
    , @NamedQuery(name = "CumulDsoH.findByDeviceNumber", query = "SELECT c FROM CumulDsoH c WHERE c.deviceNumber = :deviceNumber")
    , @NamedQuery(name = "CumulDsoH.findByDownTime", query = "SELECT c FROM CumulDsoH c WHERE c.downTime = :downTime")
    , @NamedQuery(name = "CumulDsoH.findByEnergyMismatch", query = "SELECT c FROM CumulDsoH c WHERE c.energyMismatch = :energyMismatch")
    , @NamedQuery(name = "CumulDsoH.findByEnergyMismatchRatio", query = "SELECT c FROM CumulDsoH c WHERE c.energyMismatchRatio = :energyMismatchRatio")
    , @NamedQuery(name = "CumulDsoH.findByNightCost", query = "SELECT c FROM CumulDsoH c WHERE c.nightCost = :nightCost")
    , @NamedQuery(name = "CumulDsoH.findBySaidi", query = "SELECT c FROM CumulDsoH c WHERE c.saidi = :saidi")
    , @NamedQuery(name = "CumulDsoH.findByPhaseVoltage", query = "SELECT c FROM CumulDsoH c WHERE c.phaseVoltage = :phaseVoltage")
    , @NamedQuery(name = "CumulDsoH.findByReactivePow", query = "SELECT c FROM CumulDsoH c WHERE c.reactivePow = :reactivePow")
    , @NamedQuery(name = "CumulDsoH.findBySendInterval", query = "SELECT c FROM CumulDsoH c WHERE c.sendInterval = :sendInterval")
    , @NamedQuery(name = "CumulDsoH.findByThdd", query = "SELECT c FROM CumulDsoH c WHERE c.thdd = :thdd")
    , @NamedQuery(name = "CumulDsoH.findByUpTime", query = "SELECT c FROM CumulDsoH c WHERE c.upTime = :upTime")
    , @NamedQuery(name = "CumulDsoH.findByVoltageDeviation", query = "SELECT c FROM CumulDsoH c WHERE c.voltageDeviation = :voltageDeviation")
    , @NamedQuery(name = "CumulDsoH.findByIdx12hours", query = "SELECT c FROM CumulDsoH c WHERE c.idx12hours = :idx12hours")
    , @NamedQuery(name = "CumulDsoH.findByIdx15minutes", query = "SELECT c FROM CumulDsoH c WHERE c.idx15minutes = :idx15minutes")
    , @NamedQuery(name = "CumulDsoH.findByIdx1day", query = "SELECT c FROM CumulDsoH c WHERE c.idx1day = :idx1day")
    , @NamedQuery(name = "CumulDsoH.findByIdx1hour", query = "SELECT c FROM CumulDsoH c WHERE c.idx1hour = :idx1hour")
    , @NamedQuery(name = "CumulDsoH.findByIdx1month", query = "SELECT c FROM CumulDsoH c WHERE c.idx1month = :idx1month")
    , @NamedQuery(name = "CumulDsoH.findByIdx1week", query = "SELECT c FROM CumulDsoH c WHERE c.idx1week = :idx1week")
    , @NamedQuery(name = "CumulDsoH.findByIdx1year", query = "SELECT c FROM CumulDsoH c WHERE c.idx1year = :idx1year")
    , @NamedQuery(name = "CumulDsoH.findByIdx3month", query = "SELECT c FROM CumulDsoH c WHERE c.idx3month = :idx3month")
    , @NamedQuery(name = "CumulDsoH.findByIdx6hours", query = "SELECT c FROM CumulDsoH c WHERE c.idx6hours = :idx6hours")
    , @NamedQuery(name = "CumulDsoH.findByIdx6month", query = "SELECT c FROM CumulDsoH c WHERE c.idx6month = :idx6month")})
public class CumulDsoH implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        CumulDsoH other = (CumulDsoH) object;
    ...
    public String toString() {
        return "ro.siveco.cad.integridy.entities.CumulDsoH[ id=" + id + " ]";
    }
